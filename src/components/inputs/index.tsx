...
export function Input(props: InputProps) {
    ...
    const getClassName = () => {
        let classNames = `bg-white text-black placeholder:text-placeholder transition px-4 rounded-md font-medium placeholder:font-normal text-sm border border-b border-solid border-slate-300 border-outline-none !shadow-none focus:!outline-none focus:!border-[#EBEFF8] focus:!shadow-[#EBEFF8] required:border-red-500 w-full`;
