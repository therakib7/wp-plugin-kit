...
import JobForm from '@/components/products/Form';
import JobSubmit from '@/components/products/Submit';
import jobStore from '@/data/products';
...
export default function EditJob() {
    ...
    const jobDetails: IProduct = useSelect(
        (select) => select(jobStore).getCurrentItem(id),
        []
    );
    ...
    const pageTitleContent = (
        <div className="">
            ...
            <div className="text-left">
                <PageHeading text={__('Edit Job', 'wp-plugin-kit')} />
            </div>
        </div>
    );
